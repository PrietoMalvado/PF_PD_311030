...
const { PORT } = require('./config/config');//importamos la configuracion del puerto
//:::::::::::::::::::::ROUTES:::::::::::::::::::::
const method = require('./routes/method');//importamos las rutas de pokemon
...
const config = require('./config/config');//importamos la configuracion del puerto
//:::::::::::::::::::::CONFIGURACIONES:::::::::::::::::::::
...
app.use('/method', method);//definimos la ruta /pokemon para las rutas de pokemon

app.use(notFound);

app.listen(PORT || 3000, () => { // Iniciamos el servidor en el puerto 3000
